  ...
  return (
    <footer className="bg-background border-t border-white/5 py-16">
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="font-bold text-[20px] tracking-tight text-white">
                PixlAI
              </div>
            </div>
            <p className="text-[14px] text-text-secondary leading-relaxed max-w-[240px] font-medium">
              The professional AI Photo Studio in your pocket. Coming soon to Android.
            </p>
            
            <div className="flex gap-4 mt-8">
              {/* TikTok */}
              <a href="#" className="w-10 h-10 rounded-full bg-surface border border-white/5 flex items-center justify-center hover:bg-white/5 hover:border-white/10 transition-colors text-white shadow-sm">
          ...
          {/* Product Links */}
          <div>
            <h4 className="text-[12px] uppercase tracking-[0.1em] text-text-tertiary font-bold mb-6">Product</h4>
          ...
          {/* Legal Links */}
          <div>
            <h4 className="text-[12px] uppercase tracking-[0.1em] text-text-tertiary font-bold mb-6">Legal</h4>
            <ul className="flex flex-col gap-4">
        ...
        {/* Bottom Bar */}
        <div className="mt-20 pt-8 border-t border-white/5 text-center md:text-left flex flex-col md:flex-row justify-between items-center">
          <p className="text-[13px] text-text-tertiary font-medium">
            © 2026 PixlAI. All rights reserved.
          </p>
          <p className="text-[13px] text-text-tertiary font-medium mt-2 md:mt-0">
